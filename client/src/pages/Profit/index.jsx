      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="col-span-2 lg:col-span-1">
          <div className={`glass-card p-6 h-full bg-gradient-to-br ${stats.netProfit >= 0 ? 'from-emerald-500/15 to-emerald-600/5 border-emerald-500/20' : 'from-red-500/15 to-red-600/5 border-red-500/20'}`}>
            <p className="text-sm font-medium text-white/50 mb-2">Net Profit / Loss</p>
            ...
            <div className="mt-4 pt-4 border-t border-white/10 grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-lg font-semibold text-white">{stats.savingsRate.toFixed(1)}%</p>
              </div>
              <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          ...
          <div key={label} className="glass-card p-5">
            ...
            <p className="text-xs text-white/30 mt-2">{tip}</p>
          </div>
        ))}
      </div>
